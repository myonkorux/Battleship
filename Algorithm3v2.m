...
%Tim Chang
%4/22/14
%NOTE: need checkerboard.m and Alg3Hit.m
%Once again, everything except for Case1 is identical to Alg1.
%Cases 2-5 edited using changes from Alg1
 
function [board, newhits, stepnumout, newi, newj, newfirsti, newfirstj, stepAlg3]= Algorithm3v2(board, availablehits, stepnumin, oldi, oldj, firsti, firstj,stepAlg3)
   ...
   switch stepnumin
       case 1 % check up
           if ~checkerboard(board)
               [newfirsti,newfirstj,stepAlg3] = Alg3Hit(board,stepAlg3);
           else
